import processing.core.*; import processing.serial.*; import processing.net.*; import java.applet.*; import java.awt.*; import java.awt.image.*; import java.awt.event.*; import java.io.*; import java.net.*; import java.text.*; import java.util.*; import java.util.zip.*; import javax.sound.midi.*; import javax.sound.midi.spi.*; import javax.sound.sampled.*; import javax.sound.sampled.spi.*; import java.util.regex.*; import javax.xml.parsers.*; import javax.xml.transform.*; import javax.xml.transform.dom.*; import javax.xml.transform.sax.*; import javax.xml.transform.stream.*; import org.xml.sax.*; import org.xml.sax.ext.*; import org.xml.sax.helpers.*; public class _WEBB_WebServer_RobotComputer extends PApplet {/*
...
*/
         ...
         //import the serial library to use Serial (for talking to Arduino)
            //import the net library to use Server    (for talking to the internet)
 ...
 */
public String parseRequest(String fullRequest){
 ...
 */
public void updateSerialPort(int portIndex){
 ...
 */
public String interpretRequest(String requestString){
 ...
 * F -
*/
public void sendRobotCommand(String command, int param1){
  println("command: " + command + " time: " + param1);
  String checkString = "AAA";
  if(serialPort != null){
    serialPort.write(checkString + command);
    serialPort.write(PApplet.parseByte(param1));
  }
}
...
class Button{
  ...
  static public void main(String args[]) {     PApplet.main(new String[] { "_WEBB_WebServer_RobotComputer" });  }}